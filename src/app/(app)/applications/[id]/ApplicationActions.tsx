...
const inputCls = 'w-full rounded-md border border-hairline-strong bg-surface-2 px-3 py-2 text-sm text-ink focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/50 transition-colors'
